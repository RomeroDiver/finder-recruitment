...
const renderPetsRow = (pet, index) => {
    return (
        <tr key={index}>
            <StyledTableCol>{pet.animal}</StyledTableCol>
            <StyledTableCol>{pet.colour}</StyledTableCol>
            <StyledTableCol>{pet.pattern}</StyledTableCol>
            <StyledTableCol>{pet.rating}</StyledTableCol>
            <StyledTableCol>{pet.price}</StyledTableCol>
        </tr>
    );
}
